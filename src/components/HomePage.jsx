      ...
      <div className="home-container">
            ...
            <div className="hero-stats" data-aos="fade-up" data-aos-delay="400">
              <div className="stat-item">
                ...
                <div className="stat-content">
                  <div className="stat-label">Student Friendly</div>
                </div>
              </div>
              <div className="stat-item">
              ...
              <div className="stat-item">
                ...
                <div className="stat-content">
                  <div className="stat-label">AI Based</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="features-section">
          ...
          <div className="features-grid">
            ...
            >
              ...
              <p>
                Upload certificates and let AI extract skills automatically.
                Build a professional portfolio that showcases your achievements.
              </p>
              <div className="feature-tags">
            ...
            >
              ...
              <p>
                Sharpen Your bain with Fun quizes, Logic puzzles and Explore
          ...
          <div className="steps-container">
            ...
            >
              ...
              <div className="step-content">
                ...
                <p>
                  Browse study sessions or create your own on any topic you
                  want.
                </p>
              </div>
            </div>
        ...
        <section className="cta-section">
          <div className="cta-content" data-aos="zoom-in">
            ...
            <p>
              Join students who are already studying smarter with Study Mitra.
            </p>
        ...
        <footer className="footer">
          ...
          <div className="footer-bottom">
            ...
            <p>
              Made with <FontAwesomeIcon icon={faHeart} /> for students
              worldwide
            </p>
          </div>
        </footer>
